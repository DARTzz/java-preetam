...
public class AlreadyVotedFrame extends JFrame implements MouseListener
{
	...
	public AlreadyVotedFrame()
	{
		...
		exitLabel = new JLabel("<html>Already<br>Voted!</html>");
		exitLabel.setIcon(new ImageIcon("user80.png"));
