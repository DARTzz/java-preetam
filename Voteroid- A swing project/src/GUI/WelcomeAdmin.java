...
public class WelcomeAdmin extends JFrame implements MouseListener
{
	...
	public WelcomeAdmin()
	{
		...
		exitLabel = new JLabel("<html>Welcome<br>Admin!</html>");
		exitLabel.setIcon(new ImageIcon("candidate2.png"));
		exitLabel.setIconTextGap(15);
