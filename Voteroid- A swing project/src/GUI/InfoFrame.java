...
public class InfoFrame extends JFrame implements MouseListener
{
	...
	public InfoFrame()
	{
		...
		infoLabel = new JLabel("<html>This is a currently a work in progress project by Simran Rawat and Preetam Singh."
				+ "<br>Various Improvements will be made in the coming future."
				+ "<br><br>Regards - "
				+ "<br>Simran Rawat & Preetam Singh"
				+ "<br>BSc(Hns) CS 6th sem "
				+ "<br>SGRRU, Dehradun(2018-2021)</html>");
		infoLabel.setIcon(new ImageIcon("SimranLogo.png"));
