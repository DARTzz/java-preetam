...
public class UnauthorisedVoter extends JFrame implements MouseListener
{
	...
	public UnauthorisedVoter()
	{
		...
		this.getContentPane().setBackground(new Color(213, 19, 235));
		...
		exitLabel = new JLabel("<html>Unauthorised<br>Voter !</html>");
		exitLabel.setIcon(new ImageIcon("close90.png"));
